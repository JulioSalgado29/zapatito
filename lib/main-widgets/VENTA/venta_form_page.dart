...
class _VentaFormPageState extends State<VentaFormPage> {
  ...
  double _precioBaseFirestore = 0.0; // 🔥 Nuevo: para calcular sugerido

  // --- Stock y cantidad ---
  int _stockDisponible = 0;
  int _cantidadVenta = 0;
  double _precioVentaTotal = 0.0; // 🔥 Nuevo: precio total del item
  ...
  void dispose() {
    ...
    _precioController.dispose(); // 🔥 Liberar controller
    super.dispose();
  }
  ...
  bool get _puedeVender {
    ...
    if (_precioVentaTotal <= 0) return false; // 🔥 Validar precio
    return true;
  }
  ...
  // 🔥 Función para recalcular el precio total sugerido
  ...
  Widget _buildCantidadYPrecio() {
    if (_tallaSeleccionada == null) return const SizedBox();
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildCantidadYPrecio(), // 🔥 Integrado cantidad y precio
